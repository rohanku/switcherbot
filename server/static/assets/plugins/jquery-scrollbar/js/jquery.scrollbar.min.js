!(function (l, e) {
  ...
  var o = {
    ...
    s = function (s) {
      var r;
      e.scroll ||
        ((e.overlay = !((r = c(!0)).height || r.width)),
        (e.scroll = c()),
        n(),
        l(window).resize(function () {
          ...
          if (e.scroll && (e.scroll.height || e.scroll.width)) {
            var o = c();
            (o.height === e.scroll.height && o.width === e.scroll.width) ||
              ((e.scroll = o), (l = !0));
          }
          n(l);
        })),
        ...
        (this.options = l.extend({}, o, window.jQueryScrollbarOptions || {})),
        (this.scrollTo = null),
        (this.scrollx = {}),
        (this.scrolly = {}),
        s.data(e.data.name, this),
        e.scrolls.add(this);
    };
  s.prototype = {
    destroy: function () {
    ...
    init: function (o) {
      ...
      if (
        (e.mobile && n.ignoreMobile) ||
        (e.overlay && n.ignoreOverlay) ||
        (e.macosx && !e.webkit)
      )
        return !1;
      if (d)
        ...
        if (
          ((this.wrapper = d =
            l("<div>")
              ...
              .append(r)),
          r.is("textarea") &&
            ((this.containerWrapper = t = l("<div>").insertBefore(r).append(r)),
            d.addClass("scroll-textarea")),
          t.addClass("scroll-content").css({
            height: "auto",
            "margin-bottom": -1 * e.scroll.height + "px",
            "margin-right": -1 * e.scroll.width + "px",
            "max-height": "",
          ...
          r.on("scroll" + i, function (e) {
            l.isFunction(n.onScroll) &&
              ...
              c.x.isVisible &&
                c.x.scroll.bar.css("left", r.scrollLeft() * c.x.kx + "px"),
              c.y.isVisible &&
                c.y.scroll.bar.css("top", r.scrollTop() * c.y.kx + "px");
          }),
          ...
          d.on("MozMousePixelScroll" + i, p),
            d.on("mousewheel" + i, p),
            e.mobile &&
              d.on("touchstart" + i, function (e) {
                var o =
                ...
                l(document).on("touchmove" + i, function (l) {
                  var e =
                    ...
                    l;
                  r.scrollLeft(n + s - e.pageX),
                    r.scrollTop(c + t - e.pageY),
                    l.preventDefault();
                }),
      ...
      l.each(c, function (e, o) {
        var t = null,
          ...
          f = 0;
        o.scroll ||
          ((o.scroll = s._getScroll(n["scroll" + e]).addClass("scroll-" + e)),
          n.showArrows && o.scroll.addClass("scroll-element_arrows_visible"),
          (o.mousewheel = function (l) {
          ...
          o.scroll
            .on("MozMousePixelScroll" + i, o.mousewheel)
            .on("mousewheel" + i, o.mousewheel)
            .on("mouseenter" + i, function () {
              f = r[h]();
            }),
          o.scroll
            .find(".scroll-arrow, .scroll-element_track")
            .on("mousedown" + i, function (i) {
              ...
              var c = {
                  ...
                  scrollbarOffset:
                    o.scroll.bar.offset()["x" === e ? "left" : "top"],
                  scrollbarSize:
                    o.scroll.bar["x" === e ? "outerWidth" : "outerHeight"](),
                },
                a = 0,
                v = 0;
              return (
                l(this).hasClass("scroll-arrow")
                  ? ((d = l(this).hasClass("scroll-arrow_more") ? 1 : -1),
                    (p = n.scrollStep * d),
                    (f = d > 0 ? c.maxScrollValue : 0))
                  : ((d =
                      c.eventOffset > c.scrollbarOffset + c.scrollbarSize
                        ? 1
                        : c.eventOffset < c.scrollbarOffset
                        ? -1
                        : 0),
                    (p = Math.round(0.75 * o.visible) * d),
                    (f =
                      c.eventOffset -
                      c.scrollbarOffset -
                      (n.stepScrolling
                        ? 1 == d
                          ? c.scrollbarSize
                          : 0
                        : Math.round(c.scrollbarSize / 2))),
                    (f = r[h]() + f / o.kx)),
                (s.scrollTo = s.scrollTo || {}),
                (s.scrollTo[h] = n.stepScrolling ? r[h]() + p : f),
                n.stepScrolling &&
                  ((t = function () {
                    (f = r[h]()),
                      clearInterval(v),
                ...
                setTimeout(function () {
                  s.scrollTo &&
                    (r.animate(s.scrollTo, n.duration), (s.scrollTo = null));
                }, 1),
                s._handleMouseDown(t, i)
              );
            }),
          o.scroll.bar.on("mousedown" + i, function (t) {
            ...
            return (
              ...
              l(document).on("mousemove" + i, function (l) {
                var s = parseInt(
                  (l["x" === e ? "pageX" : "pageY"] - n) / o.kx,
                  10
                );
                r[h](c + s);
              }),
        ...
        l.isFunction(n.onUpdate) && n.onUpdate.apply(this, [r]),
        l.each(c, function (l, e) {
          var o = "x" === l ? "left" : "top",
          ...
          n.autoScrollSize &&
            ((e.scrollbarSize = parseInt((d * a) / c, 10)),
            e.scroll.bar.css(t, e.scrollbarSize + "px")),
            (e.scrollbarSize = e.scroll.bar[s]()),
            (e.kx = (d - e.scrollbarSize) / (c - a) || 1),
            (e.maxScrollOffset = c - a);
        }),
      ...
      (s.isVisible = d - h > 1),
        ...
        "y" === o &&
          (r.is("textarea") || d < h
            ...
            : t.css({ "max-height": h + e.scroll.height + "px" })),
  ...
  var t,
    ...
    n =
      ...
      function (l) {
        var o, s, r, i, c, a, d;
        for (o = 0; o < e.scrolls.length; o++)
          (s = (i = e.scrolls[o]).container),
            (r = i.options),
            (c = i.wrapper),
            (a = i.scrollx),
            (d = i.scrolly),
  ...
  function c(o) {
    if (e.webkit && !o) return { height: 0, width: 0 };
    if (!e.data.outer) {
      var s = {
        border: "none",
      ...
      (e.data.inner = l("<div>").css(l.extend({}, s))),
        (e.data.outer = l("<div>")
          .css(
            l.extend(
              {
    ...
    return (
      e.data.outer.scrollLeft(1e3).scrollTop(1e3),
      {
        ...
        width: Math.ceil(
          e.data.outer.offset().left - e.data.inner.offset().left || 0
        ),
      }
    );
  }
